...
<link href="{{ asset('public/backend/product.css') }}" rel="stylesheet" type="text/css" />
...
<div class="col-12">
    ...
    <div id="variant-wrapper">
            ...
            <div class="row variant-row mb-2">
                ...
                <div class="col-md-2">
                    <input type="number" step="0.01" name="variantPrice[]" 
                           value="{{ $variant->price }}" class="form-control" placeholder="Price">
                </div>

                <div class="col-md-2">
                    <input type="number" name="variantStock[]" 
                           value="{{ $variant->stock }}" class="form-control" placeholder="Stock">
                </div>
        ...
        {{-- ✅ IF NO VARIANTS EXIST → SHOW ONE EMPTY ROW --}}
        @else
