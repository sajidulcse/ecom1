                    ...
                    <div class="table-responsive">
                        ...
                        <div style="display: flex; justify-content: center; margin-top: 20px;">
                            ...
                            ">
                                <tr>
                                    <td>
                                        <h5><strong>Sale Quantity = {{ $total_qty }}</strong></h5>
                                        <h5><strong>Sales = {{ $page_sales }}</strong></h5>
                                        <h5><strong>Purchase = {{ $page_purchase }}</strong></h5>
                                        <h5><strong>Profit = {{ $page_sales - $page_purchase }}</strong></h5>
                                    </td>
                                </tr>
                            </table>
                        </div>
