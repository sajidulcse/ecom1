...
<html lang="en">
  ...
  <body data-layout-mode="default" data-theme="light" data-layout-width="fluid" data-topbar-color="dark" data-menu-position="fixed" data-leftbar-color="light" data-leftbar-size="default" data-sidebar-user="false">
    ...
    <div id="wrapper">
      ...
      <div class="navbar-custom">
        <div class="container-fluid">
          <ul class="list-unstyled topnav-menu float-end mb-0">
            ...
            {{-- Dark/Light mode toggle -- added 2026-05-02 --}}
            <li class="d-none d-lg-inline-block">
              <a class="nav-link waves-effect waves-light" href="#" id="theme-toggle" title="Toggle Dark/Light Mode">
                <i class="fe-moon noti-icon" id="theme-icon"></i>
              </a>
            </li>
          ...
          <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            {{-- Clear all caches (optimize:clear) -- added 2026-04-15 --}}
            <li class="dropdown d-none d-xl-block">
              <a class="nav-link waves-effect waves-light" href="{{route('admin.optimize.clear')}}"
                 title="Clear Cache">
        ...
        <div class="h-100" data-simplebar>
          ...
          <div id="sidebar-menu">
            <ul id="side-menu">
              ...
              <li>
                ...
                <div class="collapse" id="siebar-sitesetting">
                  <ul class="nav-second-level">
                    ...
                    <li>
                      <a href="{{route('admin.smtp.index')}}"><i data-feather="mail"></i> SMTP Settings</a>
                    </li>
                    <li>
                      <a href="{{route('admin.ai_chat.index')}}"><i data-feather="cpu"></i> AI Chat Settings</a>
                    </li>
                    <li>
                      <a href="{{route('admin.fraud.setting')}}"><i data-feather="shield"></i> FraudBD Settings</a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              {{-- Contact Messages -- added 2026-04-15 --}}
      ...
      <div class="content-page">
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 text-end"><a href="https://www.facebook.com/sajidrana013" target="_blank">Website Designed by: Sajid Rana</a></div>
            </div>
          </div>
        </footer>
        <!-- end Footer -->
    ...
    {{-- Dark/Light mode toggle script -- added 2026-05-02 --}}
    <script>
    (function(){
        ...
        function applyTheme(theme) {
            ...
            body.setAttribute('data-topbar-color', theme === 'dark' ? 'dark' : 'dark');
            body.setAttribute('data-leftbar-color', theme === 'dark' ? 'dark' : 'light');
            icon.className = theme === 'dark' ? 'fe-sun noti-icon' : 'fe-moon noti-icon';
