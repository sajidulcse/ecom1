                                        ...
                                        <div class="product">
                                            <div class="product-cart">
                                                ...
                                                <form action="<?php echo e(route('cart.store')); ?>" method="POST" name="formName">
                                                    ...
                                                    <input type="hidden" name="variant_price" id="variant_price" value="<?php echo e($details->new_price); ?>">
                                    ...
                                    <div class="pro_des">
                                        ...
                                        <div class="pro_price">
                                            <p>
                                                ...
                                                <?php if($old > 0): ?>
                                                    <del>৳ <?php echo e(number_format($old, 2)); ?></del>
                                                <?php endif; ?>

                                                ৳ <?php echo e(number_format($new, 2)); ?>
...
<?php echo $__env->make('frontEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\ecommerce1.nextstagesoftware.com_20260507_141104\resources\views/frontEnd/layouts/pages/details.blade.php ENDPATH**/ ?>