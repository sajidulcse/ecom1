...
<link href="<?php echo e(asset('public/backend/product.css')); ?>" rel="stylesheet" type="text/css" />
...
unset($__errorArgs, $__bag); ?>" name="pro_video" value="<?php echo e(old('pro_video')); ?>" id="pro_video" />
...
unset($__errorArgs, $__bag); ?>
    ...
    <div id="variant-wrapper">
        ...
        <div class="row variant-row mb-2">
            ...
            <div class="col-md-3">
                <select name="proSize[]" class="form-control">
            ...
            <div class="col-md-3">
                <select name="proColor[]" class="form-control">
            ...
            <div class="col-md-2">
                <input type="number" step="0.01" name="variantPrice[]" class="form-control" placeholder="Price">
            </div>
...
document.addEventListener("click", function(e) {
    ...
    if (e.target.classList.contains("add-variant")) {
        ...
        row.classList.add("row", "variant-row", "mb-2");
...
<?php echo $__env->make('backEnd.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laragon\www\ecommerce1.nextstagesoftware.com_20260507_141104\resources\views/backEnd/product/create.blade.php ENDPATH**/ ?>