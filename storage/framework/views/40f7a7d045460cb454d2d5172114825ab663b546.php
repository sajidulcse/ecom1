      ...
      <div class="navbar-custom">
        <div class="container-fluid">
          ...
          <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-xl-block">
              <a class="nav-link waves-effect waves-light" href="<?php echo e(route('admin.optimize.clear')); ?>"
                 title="Clear Cache">
              ...
              <li>
                ...
                <div class="collapse" id="siebar-sitesetting">
                  <ul class="nav-second-level">
                    ...
                    <li>
                      <a href="<?php echo e(route('admin.smtp.index')); ?>"><i data-feather="mail"></i> SMTP Settings</a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('admin.ai_chat.index')); ?>"><i data-feather="cpu"></i> AI Chat Settings</a>
                    </li>
                    <li>
                      <a href="<?php echo e(route('admin.fraud.setting')); ?>"><i data-feather="shield"></i> FraudBD Settings</a>
                    </li>
                  </ul>
                </div>
              </li>
              ...
              <li>
                <a href="<?php echo e(route('admin.contact_messages.index')); ?>">
                  ...
                  <?php if($unreadMessages > 0): ?>
                    <span class="badge bg-danger float-end"><?php echo e($unreadMessages); ?></span>
                  <?php endif; ?>
                </a>
              </li>
              <!-- nav items end -->
...
<?php /**PATH F:\laragon\www\ecommerce1.nextstagesoftware.com_20260507_141104\resources\views/backEnd/layouts/master.blade.php ENDPATH**/ ?>